...
GROQ_API_KEY = "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" 
...
st.set_page_config(page_title=" Real-Time Stocks Prediction ", page_icon="", layout="wide")
st.markdown("""
    <style>
    .main { padding: 2rem; }
...
def main():
    st.title("Real-Time Stocks Prediction")
